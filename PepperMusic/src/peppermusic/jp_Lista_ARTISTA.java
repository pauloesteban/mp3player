...
public class jp_Lista_ARTISTA extends jp_Canciones {
    ...
    private void initComponents() {
        ...
        jp_Album.add(jScrollPane2);
        jScrollPane2.setBounds(0, 0, 240, 200);
        ...
        jScrollPane4.setBounds(0, 0, 242, 200);
        ...
        add(jTabbedPane1);
        jTabbedPane1.setBounds(20, 60, 242, 240);
       ...
       lista.setForeground(new java.awt.Color(255, 255, 255));
        ...
        lista.setModel(model_artista );
          ...
          jScrollPane2.setBounds(0, 0, 230, 210);
                 ...
                 try {
                       ventana.mi_reproductor.saltando=true;
                     System.out.println("album="+model_artista);
                     ventana.lista_actual=model_artista;
